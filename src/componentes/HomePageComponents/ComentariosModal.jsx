        ...
        <header className="h-25 sticky p-4 border-b border-gray-400/20  ">
          <div className="flex items-center gap-3 text-black dark:text-white">
            ...
            <div className="flex items-center gap-2">
              <span className="font-bold lg:max-w-none lg:overflow-visible md:text-ellipsis max-w-[100px] truncate whitespace-nowrap overflow-hidden">
                {item?.nombre_usuario}
              </span>
            </div>
          </div>
        ...
        <footer className="flex items-center gap-2 p-4 bg-white dark:bg-neutral-900">
          <section className="w-full gap-2 flex flex-col">
            <section className="flex w-full gap-4">
              ...
              {showEmojPicker && (
                <div className="top-10 left-30 mt-2 z-1" ref={pickerRef}>
                  <EmojiPicker
